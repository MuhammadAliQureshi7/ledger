                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12">
                        <?php foreach($request as $request):?>
                            ...
                            <fieldset class="details">
                                ...
                                <div class="field">
                                    ...
                                    <div class="field">
                                        ...
                                        <?php elseif($request->status == "More Details Required"): ?>
                                            <strong class="badge badge-info"><?php echo $request->status; ?></strong>
                                        <?php elseif($request->status == "Details Submitted"): ?>
                                            <strong class="badge badge-primary"><?php echo $request->status; ?></strong>
                                        <?php else: ?>
                                            <strong class="badge badge-secondary">Pending</strong>
                                        <?php endif;?>
                                    </div>
                                    <div class="field">
                                        <label>Date:</label>
                                    ...
                                    <!-- <?php //if($request->status == "Approved" && empty($request->paid_via)): ?>
                                        <div class="fields">
                            ...
                            <?php endif;?>
                            <?php if($request->status == "More Details Required"):?>
                                <fieldset class="details">
                                    <legend>Provide More Details for Request</legend>
                                    <form action="<?php echo base_url('user/more_details/'.$request->request_id.'?email='.$request->email."?email=".$request->email.'&full_name='.$request->full_name); ?>" method="post" enctype="multipart/form-data">
